...
module Users
  class OmniauthCallbacksController < Devise::OmniauthCallbacksController
    ...
    around_action :force_database_writing_role, only: [:google_oauth2, :github, :desktop]

    skip_before_action :verify_authenticity_token, only: [:google_oauth2, :github, :desktop]
